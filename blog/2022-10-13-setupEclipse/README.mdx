...
Windows 下也可以使用 [Chocolatey](/docs/开发/工具/包管理器/Chocolatey/) 安装 [Eclipse](https://community.chocolatey.org/packages/eclipse)：
...
Windows 下也可以使用 [Chocolatey](/docs/开发/工具/包管理器/Chocolatey/) 安装 [SpringToolsSuite](https://community.chocolatey.org/packages/SpringToolSuite)
