...
11. $y = x · \sin x$ 的微分 $dy =$ <mark>$(x \cos x + \sin x) dx$</mark>；
12. $y = x^2 · \sin x$ 的微分 $dy =$ <mark>$(2x \sin x + x^2 \cos x)dx$</mark>；
13. 设 $y = x \cos x$，则 $dy =$ <mark>$(\cos x - x \sin x)dx$</mark>；
14. 设 $y = \ln 2x$，则 $y'' =$ <mark>$-\frac{1}{4x^2}$</mark>；
15. 设 $y = e^{2x}$，则 $y'' =$ <mark>$4e^{2x}$</mark>；
16. 曲线 $y = \ln x$ 在点 $(e, 1)$ 处的切线方程为 <mark>$y - 1 = \frac{1}{e}(x - e)$</mark>；
17. 曲线 $y = x^3$ 在点 $(1, 1)$ 处的切线方程为 <mark>$y - 1 = 3(x - 1)$</mark>；
18. $\int^1_{-1} (x^2 + 2x) dx =$ <mark>$[\frac{x^3}{3} + x^2]^1_{-1} = \frac{4}{3}$</mark>；
19. $\int^1_{-1} |x| dx =$ <mark>$\int^0_{-1} (-x) dx + \int^1_0 x dx = [-\frac{x^2}{2}]^0_{-1} + [\frac{x^2}{2}]^1_0 = 1$</mark>；
20. 若 $\int f(x) dx = e^x + \sin x + C$，则 $f(x) =$<mark>$e^x + \cos x$</mark>；
21. 若 $f(x)$ 的一个原函数为 $x^2$，则 $f(x) =$<mark>$2x$</mark>；
22. $\int^2_{-2} x^2 \sin 3x dx =$<mark>$-\frac{8}{27}\cos 6$</mark>；
    <details>
    <summary>题解</summary>

    $$
    \begin{align*}
        & \int^2_{-2} x^2 \sin 3x dx \\
        & = -\frac{1}{3}x^2 \cos 3x |^2_{-2} + \frac{2}{3}\int^2_{-2} x \cos 3x dx \\
        & = -\frac{4}{9}\cos 6 + \frac{4}{9}\cos (-6) + \frac{2}{9}x \sin 3x |^2_{-2} - \frac{2}{9}\int^2_{-2} \sin 3x dx \\
        & = -\frac{8}{27}\cos 6 - \frac{4}{27}\sin 6 + \frac{4}{27}\sin (-6) - \frac{2}{27}\cos 3x|^2_{-2} \\
        & = -\frac{8}{27}\cos 6 \\
    \end{align*}
    $$
...
23. $\int^1_{-1} x^2 \sin x dx =$<mark>$4 \sin 1 - 8 \cos 1$</mark>；
    ...
    $$
    \begin{align*}
        & \int^1_{-1} x^2 \sin x dx \\
        & = -x^2 \cos x|^1_{-1} + 2\int^1_{-1} x \cos x dx \\
        & = -\cos 1 + \cos (-1) + 2(x\sin x|^1_{-1} - \int^1_{-1} \sin x dx) \\
        & = -\cos 1 + \cos (-1) + 2(\sin 1 - \sin (-1) + \cos x|^1_{-1}) \\
        & = -\cos 1 + \cos (-1) + 2(\sin 1 - \sin (-1) + (\cos 1 - \cos (-1))) \\
        & = 2(\sin 1 + \sin (1)) - 4\cos 1 + 4\cos (1) \\
        & = 4 \sin 1 - 8 \cos 1 \\
    \end{align*}
    $$
...
24. 若 $\lim\limits_{x \rightarrow a} f(x) = 0$，且 $f(x) \not = 0$，则 $\lim\limits_{x \rightarrow a} \frac{1}{f(x)} =$<mark>不确定</mark>；
25. 设 $y = x \sqrt{x \sqrt{x}}$，则 $y' =$<mark>$(3/4)x^{(5/4)}+√(x √(x))$</mark>；
26. 若 $f(x) = x \cos x$，则 $f'(0) =$<mark>$\cos(0) - 0*\sin(0) = \cos(0) = 1$</mark>；
27. 设 $y = \sqrt{1 + x}$，则 $dy =$<mark>$(dx)/(2\sqrt{(1+x)})$</mark>；
28. 若 $f(x)$ 的一个原函数为 $\sin x$，则 $f(x) =$<mark>$\cos(x)$</mark>；
29. $\int^\pi_{-\pi} x^2 \sin x dx =$<mark>$0$</mark>；
30. $\int x^2 \sqrt{x} dx =$ <mark>$\int x^{\frac{5}{2}} dx = \frac{2}{7}x^{\frac{7}{2}} + C$</mark>；
31. 函数 $y = x^2$ 的凹区间为 <mark>$(-\infty, +\infty)$</mark>；
32. 函数 $y = \frac{\ln(3x + 2)}{x - 1}$ 的定义域是 <mark>$(-\infty, -\frac{2}{3}) \cup (-\frac{2}{3}, 1) \cup (1, +\infty)$</mark>；
33. 函数 $y = e^{\sin \sqrt{x + 1}}$ 的复合过程是 <mark>$x+1 \rightarrow \sqrt{x+1} \rightarrow \sin(\sqrt{x+1}) \rightarrow e^{\sin(\sqrt{x+1})}$</mark>；
34. 极限 $\lim\limits_{x \rightarrow \infty} \frac{3x^3 - 4x^2 + 2}{2x^3 + x - 1} =$ <mark>$\frac{3}{2}$</mark>；
35. $y = \ln 3x$，则 $y'' =$ <mark>$-\frac{1}{x^2}$</mark>；
36. 设函数 $y = x^2 \sin x$，则 $y'|_{x = \pi} =$ <mark>0</mark>；
37. 已知 $y = e^{\sqrt{x}}$，则 $dy =$ <mark>$\frac{e^{\sqrt{x}}}{2\sqrt{x}}dx$</mark>；
38. 已知 $y = x^2 \sin x$，则 $dy =$ <mark>$(2x\sin x + x^2\cos x)dx$</mark>；
39. 函数 $y = x^3 - 4x + 1$ 的单调减少区间是 <mark>$(-\infty, -\sqrt{3})$</mark>；
...
44. $y = \sin(3x + 2)$ 是由 <mark>$y = \sin x$ 和 $y = 3x + 2$</mark> 函数复合而成；
45. $\lim\limits_{x \rightarrow 2} \frac{x^2 - 4}{x - 2} =$ <mark>4</mark>；
46. $\int^1_{-1} x^2 dx =$ <mark>$[\frac{x^3}{3}]^{1}_{-1} = 0$</mark>；
47. 设 $y = x^4$，则 $y'' =$ <mark>$12x^2$</mark>；
48. 设 $y = \arctan x$，则 $dy =$ <mark>$\frac{dx}{1+x^2}$</mark>；
49. 曲线 $y = \ln(x + 1)$ 在点 $(0, 0)$ 处的切线方程为 <mark>$y=x$</mark>；
...
2. $y = \sin \sqrt{2x - 1}$，求导数 $y'$；
   $$
   y' = \cos \sqrt{2x - 1} \cdot \frac{1}{\sqrt{2x - 1}}
   $$
...
2. $\int^0_{-1} (2x + 1)^10 dx$；
   $$
   \int^0_{-1} (2x + 1)^10 dx
   = \frac{(2x + 1)^{11}}{22}\Big|^0_{-1}
   = -\frac{1}{22}
   $$
...
4. $\int \frac{(x + 2)^2}{x} dx$；
   $$
   \int \frac{(x + 2)^2}{x} dx
   = \int (\frac{x^2}{x} + \frac{4x}{x} + \frac{4}{x}) dx
   = x^2 + 4x + 4\ln |x| + C
   $$
...
2. 求由曲线 $y = x^3$ 与直线 $y = 4x$ 所围成平面图形的面积。
   ...
   **解：** 设由曲线 $y = x^3$ 与直线 $y = 4x$ 所围成的图形的面积为 $S$，则
   
   $$
   S = \int_{-2}^2 (4x - x^3) dx
     = \left[2x^2 - \frac{x^4}{4}\right]_{-2}^2
     = 16 - 4
     = 12
   $$
...
当 $x=1$ 时，盒子体积最大，为 $16cm³$。

所以截去小正方形的边长为 $1cm$ 时，盒子容积最大。
