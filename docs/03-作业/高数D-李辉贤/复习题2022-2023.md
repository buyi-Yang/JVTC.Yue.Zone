...
03. $\lim\limits_{x \rightarrow \infty} \frac{x^2 + x}{3x^2 + 2} =$（）
    - A、$0$
    - B、$\frac{1}{3}$
    - C、$\infty$

04. 函数 $f(x)$ 在 $x_0$ 处可导是 $f(x)$ 在 $x_0$ 处连续的（）
    - A、必要条件
    - B、充要条件
    - C、充分条件

05. 函数 $f(x)$ 在 $x_0$ 处连续是 $f(x)$ 在 $x_0$ 处可导的（）
    - A、必要条件
    - B、充要条件
    - C、充分条件

06. 设 $f(x) = \ln \cos x$，则 $f'(x) =$（）
    - A、$\frac{1}{\cos x}$
    - B、$\tan x$
    - C、$\cot x$
    - D、$-\tan x$

07. $x \rightarrow 0$ 时，$\sin 3x$ 是 $x$ 的（）无穷小
    - A、高阶
    - B、低阶
    - C、同阶
    - D、等价
...
14. $\lim\limits_{x \rightarrow 0} \frac{\sin 2x}{x} =$（）
    - A、0
    - B、1
    - C、2

15. 函数 $y = \sqrt{4 - x^2}$ 的连续区间是（）
    - A、$[-2, 2]$
...
20. $\lim\limits{x \rightarrow \infty} \frac{\sin x}{x} =$（）
    - A、1
    - B、0
    - C、不存在
    - D、无法确定

21. 设 $f(x) = \cos x$，则 $f'(x) =$（）
    - A、$\sin x$
    - B、$\sin x + C$
    - C、$-\sin x$
    - D、$-\sin x + C$

22. $x \rightarrow 1$ 时，$x - 1$ 是 $x^2 - 1$ 的（）无穷小
    - A、高阶
    - B、低阶
    - C、同阶
    - D、等价
...
25. 函数 $y = \frac{e^x + e^{-x}}{2}$ 的图象关于（）对称
    - A、原点
    - B、$y$ 轴
    - C、$x$ 轴
    - D、直线 $y = x$

26. 当 $x \rightarrow 0$ 时，$\sin 3x$ 是 $x$ 的（）无穷小
    - A、高阶
    - B、低阶
    - C、同阶
    - D、等价

27. $f(x)$ 在点 $x_0$ 处可微是它在该点可导的（）条件
    - A、充分
    - B、充要
    - C、无关
    - D、必要

28. 设 $f(x) = \cos 2x$，则 $f''(\pi) =$（）
    - A、2
    - B、-2
    - C、4
    - D、-4

29. 曲线 $y = \sqrt{x}$ 在 $x = 1$ 点处的切线方程为（）
    - A、$x - 2y + 1 = 0$
    - B、$2x + y - 3 = 0$
    - C、$x + 2y - 1 = 0$
    - D、$2x + y + 1 = 0$
...
32. 已知 $f(x)$ 在区间 $(a, b)$ 内恒有 $f'(x) < 0, f''(x) < 0$，则曲线 $f(x)$ 在此区间内是（）
    - A、单调减少，凹的
    - B、单调减少，凸的
    - C、单调增加，凸的
