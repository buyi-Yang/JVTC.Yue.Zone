...
public class Unit3Test {
    ...
    @Test
    public void testHighestAndLowestScore() {
    ...
    @Test
    public void testCountAlphabetAndOther() {
    ...
    @Test
    public void testVoteStatistics() {
